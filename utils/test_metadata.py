TEST_METADATA = {
    "test_get_artwork": {
        "title": "Получение информации о произведении искусства по идентификатору",
        "description": "Проверка получения существующего произведения искусства",
    },
    "test_get_nonexistent_artwork": {
        "title": "Получение информации о произведении искусства с несуществующим идентификатором.",
